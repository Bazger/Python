...
class ImagePair(object):
    ...
    def __init__(self, image1, image2):
        ...
        self.relativeOrientationImage1 = np.array([0, 0, 0, 0, 0, 0]) # The relative orientation of the first image
        self.relativeOrientationImage2 = None # The relative orientation of the second image
    ...
    def RotationMatrix_Image1(self):
        ...
        :rtype: np.array 3x3
        """
        return Compute3DRotationMatrix(self.relativeOrientationImage1[0], self.relativeOrientationImage1[1],
                                       self.relativeOrientationImage1[2])
    ...
    @relativeOrientationImage2.setter
    def relativeOrientationImage2(self,val):
        self.__relativeOrientationImage2=val
    ...
    def drawImagePair(self,modelPoints,ax):
        ...
        orient1 = self.relativeOrientationImage1
        orient2 = self.relativeOrientationImage2
        ...
        f=self.image1.camera.focalLength
        scale=0.000025
        x = 2*self.image1.camera.principalPoint[0]
        y = 2*self.image1.camera.principalPoint[1]
    ...
    def ImagesToGround(self, imagePoints1, imagePoints2, Method):
        ...
        **Usage example**
        ...
        """
        exterior1 = self.relativeOrientationImage1
        exterior2 = self.relativeOrientationImage2
